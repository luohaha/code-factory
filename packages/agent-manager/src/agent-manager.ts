...
export class AgentManager extends EventEmitter {
  ...
  private buildRdDeveloperInstructions(): string {
    return [
      ...
      'Use code-factory-cli requirement conversation with --requirement-id to read another Requirement\'s conversation, with optional head, tail, or page selection. The command rejects this Requirement\'s own ID because its conversation is already present in this Session.',
