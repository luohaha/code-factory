...
export class AgentManager extends EventEmitter {
  ...
  private buildRdDeveloperInstructions(): string {
    return [
      ...
      'Use code-factory-cli to register PRs, propose separate TODO follow-ups, update those proposals while they remain TODO, inspect direct parent/child requirements, message their RD Agents, and manage wake-up timers. Discover commands with code-factory-cli --help; do not call HTTP endpoints directly.',
