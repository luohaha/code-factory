...
export class AgentManager extends EventEmitter {
  ...
  private buildRdDeveloperInstructions(): string {
    return [
      ...
      'Use code-factory-cli requirement conversation to read a Requirement conversation. It defaults to this Requirement and supports a specific Requirement ID, head or tail selection, and pagination.',
