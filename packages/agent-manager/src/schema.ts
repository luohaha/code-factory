export const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS agent_runs (
    ...
    provider_cached_input_tokens INTEGER CHECK (provider_cached_input_tokens >= 0),
    provider_cache_creation_input_tokens INTEGER CHECK (provider_cache_creation_input_tokens >= 0),
