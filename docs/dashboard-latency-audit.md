...
- A full snapshot that finishes after a newer SSE event is merged rather than blindly replacing live state. Requirement deletion/purge IDs remain tombstoned during that race, so an older response cannot resurrect a removed card.
